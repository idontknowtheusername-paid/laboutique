    ...
    <div className="min-h-screen bg-beshop-background">
      ...
      <div className="container py-8">
        ...
        <div className="text-center mb-10">
          <Badge className="bg-beshop-primary/10 text-beshop-primary mb-3">Questions fréquentes</Badge>
        ...
        <div className="text-center mt-10">
          ...
          <Link href="/contact">
            <Button className="bg-beshop-primary hover:bg-blue-700">Contacter le support</Button>
          </Link>
        </div>
      </div>
