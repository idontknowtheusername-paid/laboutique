    ...
    <div className="min-h-screen bg-jomionstore-background">
      ...
      <div className="container py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Rejoignez des milliers de vendeurs et développez votre activité sur JomionStore Hub, le centre commercial digital du Bénin.</p>
        </div>
