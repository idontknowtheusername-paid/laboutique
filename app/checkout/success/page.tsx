          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-x-4">
                <Link href="/account/orders" className="text-jomionstore-primary hover:underline">Voir mes commandes</Link>
                <Link href="/" className="text-jomionstore-primary hover:underline">Continuer mes achats</Link>
              </div>
            </CardContent>
          </Card>
        </div>
