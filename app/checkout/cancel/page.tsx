          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-x-4">
                <Link href="/checkout" className="text-beshop-primary hover:underline">Réessayer</Link>
                <Link href="/cart" className="text-beshop-primary hover:underline">Voir mon panier</Link>
              </div>
            </CardContent>
          </Card>
        </div>
