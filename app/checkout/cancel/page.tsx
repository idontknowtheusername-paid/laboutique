          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-x-4">
                <Link href="/checkout" className="text-jomionstore-primary hover:underline">Réessayer</Link>
                <Link href="/cart" className="text-jomionstore-primary hover:underline">Voir mon panier</Link>
              </div>
            </CardContent>
          </Card>
        </div>
