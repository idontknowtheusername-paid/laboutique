            ...
            <CardContent>
              {done ? (
                ...
                <form onSubmit={submit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-beshop-primary hover:bg-blue-700">Mettre à jour</Button>
                </form>
              )}
              <p className="text-sm text-gray-600 mt-4 text-center">
                <Link href="/auth/login" className="text-beshop-primary hover:underline">Se connecter</Link>
              </p>
            </CardContent>
          </Card>
        </div>
