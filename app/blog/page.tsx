...
const blogPosts = [
  ...
  {
    id: 3,
    title: 'Be Shop x Vendeurs : Meilleures pratiques 2025',
  ...
  },
  {
    ...
    excerpt: 'Conseils pratiques pour acheter en toute sécurité sur Be Shop et éviter les arnaques.',
    content: 'Contenu complet de l\'article...',
  ...
  return (
    <div className="min-h-screen bg-beshop-background">
      ...
      <div className="container py-8">
          ...
          <Card className="mb-12 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <CardContent className="p-8 flex flex-col justify-center">
                ...
                <Button className="bg-beshop-primary hover:bg-blue-700 w-fit">
                  Lire l'article
        ...
        {/* Newsletter CTA */}
        <Card className="mt-12 bg-gradient-to-r from-beshop-primary to-blue-600 text-white">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row max-w-md mx-auto gap-3">
              ...
              />
              <Button className="bg-beshop-secondary hover:bg-orange-600">
                S'abonner
              </Button>
            </div>
          </CardContent>
