...
export const PageLoading: React.FC<PageLoadingProps> = ({
    ...
    return (
        <div className={`flex flex-col items-center justify-center min-h-[400px] ${className}`}>
            <Loader2 className="w-8 h-8 animate-spin text-jomiastore-primary mb-4" />
    ...
    return (
        <div className={`fixed inset-0 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center z-50 ${className}`}>
            <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center">
                <Loader2 className="w-12 h-12 animate-spin text-jomiastore-primary mb-4" />
...
export const InlineLoading: React.FC<PageLoadingProps> = ({
    ...
    return (
        <div className={`flex items-center justify-center py-8 ${className}`}>
            <Loader2 className="w-5 h-5 animate-spin text-jomiastore-primary mr-2" />
