...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  const getColors = () => {
    switch (toast.type) {
      ...
      case 'info': return 'border-orange-200 bg-orange-50 dark:bg-orange-900/20 dark:border-orange-800';
    }
  };
...
export function LoadingToast({ 
  ...
  return (
    <Card className="w-80 shadow-lg border-orange-200 bg-orange-50 dark:bg-orange-900/20 dark:border-orange-800">
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0">
