...
interface HeroCarouselVariantsProps {
  banners?: HeroBanner[];
  variant?: HeroVariant;
  autoRotate?: boolean;
...
const HeroCarouselVariants: React.FC<HeroCarouselVariantsProps> = ({
  banners = [],
  variant = 'balanced',
  autoRotate = true,
  showControls = true,
  ...
  if (isLoading) {
    return (
      <div className={`relative ${styles.container} overflow-hidden rounded-xl shadow-2xl bg-gray-200 animate-pulse ${className}`}>
  ...
  if (displayBanners.length === 0) {
    return (
      <div className={`relative ${styles.container} overflow-hidden rounded-xl shadow-2xl bg-gray-100 ${className}`}>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
  ...
  return (
    <div 
      ref={carouselRef} 
      className={`relative ${styles.container} overflow-hidden rounded-xl shadow-2xl group ${className}`}
            ...
            <div className="relative h-full flex items-center">
              <div className="container">
                <div className={`${styles.content} text-white`}>
                  ...
                  {/* Title */}
                  <h2 className={`${styles.title} font-bold mb-4 animate-fade-in`}>
                    {banner.title}
                  </h2>
                  
                  {/* Subtitle */}
                  {banner.subtitle && (
                    <h3 className={`${styles.subtitle} font-light mb-4 animate-fade-in`} style={{ animationDelay: '0.2s' }}>
                      {banner.subtitle}
                    </h3>
                  )}
                  ...
                  {/* Description */}
                  {banner.description && (
                    <p className={`${styles.description} mb-6 opacity-90 animate-fade-in`} style={{ animationDelay: '0.4s' }}>
                      {banner.description}
                    </p>
                  )}
                  ...
                  <Link href={banner.cta_link}>
                    <Button 
                      size="lg" 
                      className={`bg-white text-gray-900 hover:bg-gray-100 font-semibold ${styles.button} animate-fade-in hover-lift`}
...
export default HeroCarouselVariants;