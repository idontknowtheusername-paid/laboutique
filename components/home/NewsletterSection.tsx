  ...
  return (
    <section className="py-12 bg-white">
      <div className="container">
        {/* Newsletter */}
        <div className="bg-gradient-to-r from-jomiastore-primary to-blue-600 rounded-xl p-8 md:p-12 text-white text-center mb-12">
          <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row max-w-md mx-auto space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <Button 
                type="submit"
                className="bg-jomiastore-secondary hover:bg-orange-600 px-8 h-12 font-semibold"
              >
                S'abonner
              </Button>
            </form>
