-- Optimisations de base de données pour la scalabilité (VERSION FINALE)
...
-- 5. INDEX POUR PERFORMANCE - PROFILS
...
-- Politiques pour les profils (utilisateur propriétaire)
...
BEGIN
    ...
    -- Note: Créer d'abord la table orders_archive si elle n'existe pas
